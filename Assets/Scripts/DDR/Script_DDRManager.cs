...
public class Script_DDRManager : MonoBehaviour
{
    ...
    */
    ...
    void HandleAction()
    {
        ...
        if (
            Input.GetButtonDown(Script_KeyCodes.Left)
        )
        {
        ...
        if (Input.GetButtonDown(Script_KeyCodes.Down))
        {
        ...
        if (Input.GetButtonDown(Script_KeyCodes.Up))
        {
        ...
        if (Input.GetButtonDown(Script_KeyCodes.Right))
        {
